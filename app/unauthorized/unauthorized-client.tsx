...
export default function UnauthorizedClient({ nome, perfilLabel }: Props) {
    ...
    <div className="space-y-4">
        ...
        <div className="flex items-start gap-3">
          ...
          <div>
            ...
            <ul className="text-sm text-muted-foreground space-y-1">
              ...
              <li>• Seu perfil atual: {perfilLabel ?? '—'}</li>
              <li>
      ...
      <Card className="p-3 bg-gray-50 border-gray-200">
        <div className="text-sm text-muted-foreground text-left">
          <p>
            <span className="font-medium">Logado como:</span> {nome ?? 'Usuário'}
          </p>
          <p>
            <span className="font-medium">Perfil:</span> {perfilLabel ?? '—'}
          </p>
        </div>
      </Card>
    </div>
