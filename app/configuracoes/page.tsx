...
// Mock data
const mockLevels = [
  { id: "n1", nome: "L1", nivelAnterior: null, pessoas: 8, cargos: 2, ativo: true },
  { id: "n2", nome: "L2", nivelAnterior: "L1", pessoas: 15, cargos: 4, ativo: true },
  { id: "n3", nome: "L3", nivelAnterior: "L2", pessoas: 22, cargos: 5, ativo: true },
  { id: "n4", nome: "L4", nivelAnterior: "L3", pessoas: 18, cargos: 6, ativo: true },
  { id: "n5", nome: "L5", nivelAnterior: "L4", pessoas: 12, cargos: 5, ativo: true },
  { id: "n6", nome: "L6", nivelAnterior: "L5", pessoas: 8, cargos: 4, ativo: true },
  { id: "n7", nome: "L7", nivelAnterior: "L6", pessoas: 3, cargos: 2, ativo: true },
  { id: "n8", nome: "L8", nivelAnterior: "L7", pessoas: 1, cargos: 1, ativo: true },
]

const mockTrilhas = [
  { id: "t1", nome: "Engenharia de Software", descricao: "Desenvolvimento e arquitetura de software", cargos: 12, pessoas: 58, ativo: true },
  { id: "t2", nome: "Produto", descricao: "Product Management e estratégia", cargos: 8, pessoas: 18, ativo: true },
  { id: "t3", nome: "Design", descricao: "UX/UI Design e Research", cargos: 6, pessoas: 12, ativo: true },
  { id: "t4", nome: "Dados", descricao: "Data Science e Analytics", cargos: 7, pessoas: 15, ativo: true },
  { id: "t5", nome: "Marketing", descricao: "Marketing e Growth", cargos: 5, pessoas: 10, ativo: true },
  { id: "t6", nome: "Operações", descricao: "Operações e Infraestrutura", cargos: 4, pessoas: 14, ativo: true },
]

const mockTags = [
  { id: "tag1", nome: "Frontend", cor: "#FF7A00", pessoas: 15, projetos: 0 },
  { id: "tag2", nome: "Backend", cor: "#1A2734", pessoas: 20, projetos: 0 },
  { id: "tag3", nome: "Full Stack", cor: "#00C8FF", pessoas: 8, projetos: 0 },
  { id: "tag4", nome: "Leadership", cor: "#9333EA", pessoas: 12, projetos: 0 },
  { id: "tag5", nome: "Mentor", cor: "#10B981", pessoas: 10, projetos: 0 },
  { id: "tag6", nome: "React", cor: "#61DAFB", pessoas: 18, projetos: 0 },
  { id: "tag7", nome: "Node.js", cor: "#339933", pessoas: 15, projetos: 0 },
  { id: "tag8", nome: "TypeScript", cor: "#3178C6", pessoas: 22, projetos: 0 },
]

const mockLoginActivity = [
  { data: "2024-11-16 10:30", device: "Chrome 120 - Windows", ip: "192.168.1.10", location: "São Paulo, BR", status: "success" },
  { data: "2024-11-15 18:45", device: "Firefox 119 - macOS", ip: "192.168.1.10", location: "São Paulo, BR", status: "success" },
  { data: "2024-11-14 09:20", device: "Safari 17 - iOS", ip: "192.168.1.50", location: "São Paulo, BR", status: "success" },
]
...
export default function ConfiguracoesPage() {
        ...
        return (
          <div className="space-y-6">
            ...
            <Card className="p-6">
              ...
              <div className="mt-6">
                <Button onClick={() => console.log("Save preferences")}>Salvar Preferências</Button>
              </div>
            </Card>
          </div>
        )
          ...
          <div className="space-y-6">
            ...
            <Card className="p-6">
              ...
              <div className="space-y-4">
                ...
                <Button onClick={() => console.log("Change password")}>Alterar Senha</Button>
              </div>
            </Card>
                  ...
                  <tbody className="text-sm">
                    {mockLoginActivity.map((activity, index) => (
                      <tr key={index} className="border-b last:border-0">
                        <td className="py-3">{activity.data}</td>
                        <td className="py-3">{activity.device}</td>
                        <td className="py-3">{activity.ip}</td>
                        <td className="py-3">{activity.location}</td>
                        <td className="py-3">
            ...
            <Card className="p-6">
              ...
              <div className="rounded-lg bg-gray-50 p-4">
                ...
                <Button variant="outline" onClick={() => console.log("Enable 2FA - coming soon")}>
                  Ativar 2FA
                </Button>
              </div>
            </Card>
        ...
        return (
          <div className="space-y-6">
            ...
            <Card className="p-6">
              ...
              <div className="mt-6">
                <Button onClick={() => console.log("Save notification preferences")}>Salvar Preferências</Button>
              </div>
            </Card>
          </div>
        )
              ...
              <Card className="p-6">
                <div className="flex items-center justify-between">
                  <div>
                    ...
                    <p className="mt-1 text-3xl font-bold text-secondary">15</p>
                  </div>
              ...
              <Card className="p-6">
                <div className="flex items-center justify-between">
                  <div>
                    ...
                    <p className="mt-1 text-3xl font-bold text-green-600">12</p>
                  </div>
              ...
              <Card className="p-6">
                <div className="flex items-center justify-between">
                  <div>
                    ...
                    <p className="mt-1 text-3xl font-bold text-gray-600">3</p>
                  </div>
          ...
          <div className="space-y-6">
            ...
            <Card className="p-6">
              <div className="mb-4 rounded-lg bg-accent/10 p-4">
                ...
                <Badge className="mt-2 bg-accent text-white">Faixa em uso: L1 até L8</Badge>
              </div>
            </Card>
                  ...
                  <tbody className="text-sm">
                    {mockLevels.map((level) => (
                      <tr key={level.id} className="border-b last:border-0">
                        <td className="py-3 font-medium">{level.nome}</td>
                        <td className="py-3">{level.nivelAnterior ? `→ ${level.nivelAnterior}` : "—"}</td>
                        <td className="py-3">
                          <Badge variant="secondary" className="text-white">{level.pessoas} pessoas</Badge>
                        </td>
                        <td className="py-3">
                          <Badge variant="secondary" className="text-white">{level.cargos} cargos</Badge>
                        </td>
                        <td className="py-3">
                          <Switch checked={level.ativo} />
                        </td>
                        <td className="py-3">
                          <Button
                            variant="ghost"
              ...
              <Card className="p-6">
                <div className="flex items-center justify-between">
                  <div>
                    ...
                    <p className="mt-1 text-3xl font-bold text-secondary">6</p>
                  </div>
              ...
              <Card className="p-6">
                <div className="flex items-center justify-between">
                  <div>
                    ...
                    <p className="mt-1 text-3xl font-bold text-secondary">42</p>
                  </div>
                        ...
                        <td className="py-3">
                          <div className="flex gap-2">
                            <Button
                              ...
                              size="sm"
                              onClick={() => {
                                setEditingItem(trilha)
                                setShowTrilhaModal(true)
                              }}
                            >
                              <Edit className="h-4 w-4" />
                            </Button>
                            <Button variant="ghost" size="sm" onClick={() => console.log("Delete trilha", trilha.id)}>
                ...
                {mockTags.map((tag) => (
                  ...
                  >
                    ...
                    <div className="absolute right-2 top-2 flex gap-1 opacity-0 transition-opacity group-hover:opacity-100">
                      ...
                      {tag.pessoas === 0 && (
                        <Button variant="ghost" size="sm" className="h-7 w-7 p-0" onClick={() => console.log("Delete tag", tag.id)}>
  ...
  return (
    <DashboardShell>
      ...
      {/* Level Modal (Placeholder, as it's not fully implemented in the provided snippet) */}
      <Dialog open={showLevelModal} onOpenChange={setShowLevelModal}>
        <DialogContent className="sm:max-w-lg w-full p-0">
          <div className="p-6">
            ...
            <div className="mt-4 space-y-4">
              {/* Add input fields for level name, previous level, etc. */}
              <p>Level modal content goes here...</p>
            </div>
          </div>
          <DialogFooter className="border-t p-6">
